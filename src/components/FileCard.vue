<template>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 px-4 pt-4 pb-16">
        <div v-for="(question, index) in requiredQuestions" :key="index" class="bg-white rounded-xl shadow-sm p-3">
            <router-link :to="{ name: 'Survey', params: { title: question.title } }">
                <div class="flex flex-col items-start justify-center gap-2">
                    <div class="overflow-hidden"><img :src="question.img" class="w-full rounded-lg scale-125" alt=""></div> 
