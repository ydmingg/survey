      ...
      <main class="max-w-3xl mx-auto px-4 pt-20 pb-16">
        ...
        <form @submit.prevent="submitSurvey" class="space-y-8">
          ...
          <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-start gap-2">
              <h3 class="text-lg font-medium mb-4">其他意见或建议</h3>
              <span class="text-gray-400">(选填)</span>
            </div>
            <textarea
              v-model="comments"
...
const requiredQuestions = ref([
    { id: 1, title: '1. 工作效率', rating: null },
    { id: 2, title: '2. 服务态度', rating: null },
    { id: 3, title: '3. 创新能力', rating: null },
])

// 选填项数据
const optionalQuestions = ref([
    { id: 4, title: '4. 团队协作', rating: null },
    { id: 5, title: '5. 专业水平', rating: null },
])
